...
public class ConfirmCartPanel extends
    ...
    private void doConfirmCart(final RestServletAsync rpcService, final RestGWT rootPage) {
        ...
        rpcService.confirmCart(rootPage.getActiveUser(), checksLst, new AsyncCallback<FaturaDto>() {

            @Override
            public void onSuccess(FaturaDto result) {
                ...
                new FaturaPanel(result, rootPage, rpcService).show();
            }
